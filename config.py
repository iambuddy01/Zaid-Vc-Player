...
OWNER_USERNAME = getenv("OWNER_USERNAME", "ceoage")
ALIVE_NAME = getenv("ALIVE_NAME", "Zaid")
BOT_USERNAME = getenv("BOT_USERNAME", "Zaidtestisbot")
OWNER_ID = getenv("OWNER_ID", "8207267754")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "Zaid2_Assistant")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "WTF_KARMA")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "FINE_N_OK")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("UPDATES_CHANNEL", "HEROKU_API_KEY")
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "8207267754").split()))
